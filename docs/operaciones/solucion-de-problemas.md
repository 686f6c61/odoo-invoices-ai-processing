...
1. que el servidor entrante supera **Probar y confirmar**;
2. que el buzón contiene el mensaje como no leído;
3. que el modelo de destino es `AI Processing incoming email`;
4. que **Conservar adjuntos** está activado;
5. que SPF, DKIM o DMARC no rechazaron el mensaje;
6. que el dominio del remitente está permitido;
7. que la acción programada de correo entrante está activa;
8. los logs del sistema de correo de Odoo.

Consulte la configuración completa en
[Elegir y conectar el correo](../administracion/correo.md).
